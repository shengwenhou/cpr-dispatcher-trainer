...
**核心引擎完成，課堂 UI 開發前。** STT spike 通過（macOS 26 SpeechTranscriber zh_TW 定案）、台詞庫 85 句經急診醫師逐句審定並完成語音合成、FSM 對話引擎＋三 Provider 介面就緒（pytest 99）。完整規格見 [SPEC.md](SPEC.md)，進度見 [PROGRESS.md](PROGRESS.md)。
...
| [docs/engine.md](docs/engine.md) | 對話引擎架構文件（FSM、五層防禦、Provider、文字模式 harness——開發者向） |
